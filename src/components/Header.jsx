  ...
  return (
    <li className="relative group">
      {item.type === "link" ? (
        ...
        <>
          <a href="/" className="px-4 py-2 flex gap-x-2 items-center">
            <span>{item.name}</span>
            <MdKeyboardArrowDown />
          </a>
    ...
    <section>
      <header className="container mx-auto px-5 flex justify-between py-4 items-center">
        ...
        <div
          ...
          } transition-all duration-300 mt-[56px] lg:mt-0 bg-dark-hard lg:bg-transparent z-[49] flex flex-col lg:flex-row justify-center lg:justify-end w-full lg:w-auto fixed top-0 bottom-0 lg:static gap-x-9 items-center`}
        >
